...
// FUNCTION TO CREATE SALES DATA TABLE
  this.createSalesTable = function () {
  ...
  //MAKE THIS A STAND ALONE FUNCTION OUTSIDE OF THE CONSTRUCTOR TO MAKE FOOTER ROW  --- NEEDS TO BE ADAPATED
    this.createSalesTable = function () {
      var salesDataTable = document.getElementById('salesDataTable');
